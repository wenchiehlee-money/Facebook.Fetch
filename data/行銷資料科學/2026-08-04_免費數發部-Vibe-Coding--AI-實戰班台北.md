---
post_id: "1347196350857340"
title: "【免費】數發部 Vibe Coding × AI 實戰班！（台北）"
page_title: ""
...
🔥 熱烈迴響，實戰課程再次開放報名！
很榮幸我們再次有機會與數位發展部共同合作本次課程！這次將帶領大家運用 Vibe Coding × AI，實際打造工業數據分析與規格比對 Agent，協助提升資料處理效率，讓複雜的工業數據與產品規格比對更加快速、精準！

這堂課特別適合：
✔ 想學習 AI，卻沒有完整程式開發經驗
✔ 經常需要整理、分析工業製程數據
✔ 想提升產品零組件規格比對效率
✔ 想將 Vibe Coding 實際應用於工作流程
課程將從 AI 與 Vibe Coding 的基礎觀念開始，帶你一步步掌握實作流程，並實際打造工業數據分析與規格比對 Agent，將 AI 真正導入製造業與工程應用情境！

📅 課程日期｜8/11（二）
⏰ 課程時間｜09:30–16:30
📍 課程地點｜台北科技大樓BR6４樓中會議室(台北市復興南路二段237號4樓)。
💡 課程主題｜Vibe Coding × AI 打造工業數據分析與規格比對 Agent 實戰班

很歡迎大家到現場一起實作、交流，掌握 AI Agent 在工業與製造業中的實際應用！
報名截止｜8/9（日）17:00

名額有限，想學會運用 AI 處理工業數據、提升規格比對效率的朋友，記得把握這次免費學習機會！
