---
post_id: "122181083786799750"
title: "【 聯發科可能是 Elon Musk 打造 Terafab 的關鍵拼圖 】"
page_title: ""
...
此策略合作可望強化 Terafab 的執行效率，並提升聯發科 AI ASIC 的產業定位與附加價值。

以下從 Terafab 的執行挑戰與聯發科的對應能力兩個面向分析。

──

▌Musk 的半導體 / 晶片願景無疑有著激勵人心的長期敘事，但其所屬的 IC 設計團隊同時也面臨多重執行面壓力：

»» 壓力 1：範疇

» 3 條先進製程合作路徑：同時與台積電、Samsung 與 Intel 合作，在 IC 設計業界前所未見。
» 2 大算力產品線：地面（邊緣 / 推論）與專為宇宙環境優化的晶片，遠期 AI 算力量級規劃挑戰地球部署總和。
» 6+ 晶片專案：AI 系列、Dojo 系列、SpaceX 專屬晶片，同時涵蓋多個應用領域。
» 4 關鍵流程垂直整合：光罩設計、邏輯、記憶體晶片與先進封裝，單一廠區整合此規模產業內無先例。
» 9 個月設計週期：vs. 產業常態 18-24 個月，複雜設計 2-3 年，迭代速度顯著較快。

»» 壓力 2：時間

Terafab 採用的 Intel 14A，其 PDK 0.9 預計於 2026 年 10 月釋出給外部客戶，使外部客戶首度能參與 14A 實際設計。若 Terafab 沒有第一時間掌握，可能會錯過 2028 年 Intel 14A 小批量生產，不利達到 2028 年試產的目標，甚至面臨落後一個製程世代的風險。

此外，根據我最新的產業調查顯示，Terafab 對設備商提出顯著高於市場行情的價格以購買關鍵設備，也驗證了時間壓力這件事。

»» 壓力 3：人力

對照全球一線 IC 設計團隊 Apple 的矽晶工程團隊（SEG；Silicon Engineering Group），粗估其人力規模是 SpaceX 與 Tesla 加總的數倍到數十倍，後者卻要在更緊迫的時間壓力下執行更廣的營運範疇。

【 結論 】Terafab 的真正挑戰在於面對多重壓力下的執行力。因首次與 Intel 合作並採用其先進製程 14A 與先進封裝，故與適當的客製化 ASIC 廠商（custom ASIC partner）合作，有助於加速並成功導入 Intel 技術。

──

▌聯發科因符合以下條件，故為 Terafab 的最佳合作對象：

»» Intel 生態系實際合作經驗

聯發科同時具有投片前段製程（Intel 16）與參與先進封裝 EMIB-T 的經驗，因更熟悉與 Intel 合作模式，故可協助 Terafab 掌握 14A PDK 0.9 釋出後的數月黃金窗口，以及後續製造。

»» 與 Google 合作 TPU 超預期，展現的能力高度符合 Terafab 所需

聯發科與 Google 首度合作 TPU，8t 將於 4Q26 量產、Humufish 於 2H27 量產且開發進度超預期，代表具備與客戶合作 Semi-COT 模式、EMIB-T 生產協同能力與 Tier-1 量級量產經驗，而這些剛好都是目前 Terafab 高度所需。
...
台積電的成功眾所週知，24/7 輪班研發模式的夜鷹計畫是該公司提升執行效率的關鍵之一，連韓國政界與半導體業界也曾呼籲政府應修法並仿效台灣。這也意味著聯發科的價值，除公司能力外，還包括能將整個台灣加速研發生態系導入 Terafab 的能力。
